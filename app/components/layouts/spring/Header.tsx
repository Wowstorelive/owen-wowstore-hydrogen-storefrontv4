...
function DesktopHeader({
  ...
  return (
    <header
      role="banner"
      className="z-30 bg-white text-black hidden lg:flex flex-col leading-none sticky top-0 border-b header-style"
    >
        ...
        <div className="flex items-center gap-x-5">
          <div>
            ...
            >
              ...
              {searchInputShow && (
                <div className="absolute flex items-center gap-2 right-6 rtl:right-auto rtl:left-6 bg-white header-style">
                  <button type="submit" className="flex items-center">
                    <IconSearch />
                  </button>
                  <Input
                    type="text"
                    className="border-0 border-b bg-white text-black focus:ring-0 header-style"
            ...
            {
              show && <Recommendation valueSearch={valueSearch} customClass="mt-5" />
            }
          </div>
          <Link
            to="/account"
