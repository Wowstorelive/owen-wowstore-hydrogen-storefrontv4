...
export function Footer({settings}: {settings?: any}) {
  ...
  return (
    <Section
      ...
      as="footer"
      role="contentinfo"
      className="mt-20 bg-white text-[15px] footer-style"
    >
  ...
  return (
    <section className="pt-10 lg:pt-20 pb-6 md:pb-0">
      <div className="container lg:max-w-4xl">
        <div className="w-full text-xl text-center md:text-2xl font-medium uppercase">
        ...
        <Newsletter inputClass="border py-2 md:-mr-1" />
      </div>
    </section>
  );
}
...
function FooterMenu({
  ...
  return (
    <>
      <section className="container grid grid-flow-row py-6 divide-y divide-black divide-opacity-25 lg:py-16 lg:grid-cols-7 lg:gap-4 lg:divide-none">
        <section className="col-span-1 pt-0 pb-6 md:pt-6 lg:pt-0 lg:col-span-2 lg:pr-32 lg:pb-0">
          <p className="mb-6">
            <img
              src={logo.url}
              width={logo.width}
          ...
          <Disclosure>
            {({open}) => (
              <Disclosure.Button className="w-full text-left lg:cursor-default">
                <Heading
                  as="h3"
                  className="relative flex justify-between text-base font-medium tracking-wide lg:mb-8 uppercase"
                >
...
function FooterBottom({others}: {others: any}) {
  ...
  return (
    <div className="border-t text-sm text-black copyright-style">
