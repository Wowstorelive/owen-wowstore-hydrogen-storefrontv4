...
export function Footer({settings}: {settings?: any}) {
  ...
  return (
    <Section
      ...
      as="footer"
      role="contentinfo"
      className="bg-black text-white mt-12 md:mt-20 text-sm footer-style"
    >
...
function FooterMenu({
  ...
  return (
    <>
      <section className="container grid grid-flow-row py-6 divide-y divide-white divide-opacity-25 lg:py-12 lg:grid-cols-7 lg:gap-4 lg:divide-none">
        <section className="text-white col-span-1 pb-6 md:pt-6 lg:py-0 lg:col-span-2 lg:pr-10">
          <p className="mb-6">
            <img
              src={logo.url}
              width={logo.width}
